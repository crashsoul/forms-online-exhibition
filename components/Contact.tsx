        ...
        <AnimatePresence mode="wait">
          {status === 'success' ? (
            <motion.div
              ...
              className="flex flex-col items-center justify-center gap-6 text-center py-24 w-full"
            >
              <h3 className="font-serif text-2xl md:text-3xl font-light text-[#1a1a1a]">
                Thank you.
              </h3>
              <p className="font-sans text-sm text-[#1a1a1a]/70 max-w-sm leading-relaxed">
                Your inquiry has been received. I will review it and get back to you shortly.
              </p>
              <button
                onClick={() => setStatus('idle')}
                className="mt-8 text-[10px] md:text-xs uppercase tracking-[0.2em] text-[#1a1a1a]/50 hover:text-[#1a1a1a] transition-colors border-b border-transparent hover:border-[#1a1a1a]/30 pb-1"
              >
